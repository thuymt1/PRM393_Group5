  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            _buildBookingList(
              context,
              'upcoming',
            ), // Danh sách chuyến đi sắp khởi hành
            _buildBookingList(
              context,
              'completed',
            ), // Danh sách chuyến đi đã hoàn thành lịch trình
            _buildBookingList(
              context,
              'cancelled',
        ...
        bottomNavigationBar:
            _buildBottomNavBar(), // Thanh thực đơn điều hướng cố định dưới đáy màn hình
      ),
    );
  }
        ...
        : [
            {
              ...
              'price': '1.700.000đ',
              'image':
                  'https://images.unsplash.com/photo-1449156001437-3a1441df910b?q=80&w=1000',
            },
          ];
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return _buildBookingCard(
          context,
          bookings[index],
        ); // Vẽ cấu trúc chi tiết từng thẻ Card cụ thể
      },
    );
  }
