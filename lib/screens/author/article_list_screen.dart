  ...
  final List<Map<String, dynamic>> _allArticles = [
    {
      ...
      'excerpt':
          'Đà Lạt luôn là chốn bình yên mỗi khi mỏi mệt. Lần này mình chọn The Pine Hill và thực sự bị đốn tim bởi phong cảnh thông reo rì rào...',
    ...
    },
    {
      ...
      'excerpt':
          'Nằm ẩn mình giữa những tán thông xanh, The Terracotta Nest mang lại trải nghiệm ấm cúng, gần gũi thiên nhiên với phong cách kiến trúc mộc mạc...',
    ...
    },
    {
      ...
      'excerpt':
          'Mùa đông Sapa thật tuyệt để đi trốn cùng người thương. Dưới đây là bài review chi tiết về 3 homestay siêu lãng mạn có view ngắm mây...',
    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          ...
          _buildArticleList(
            _allArticles.where((a) => a['status'] == 'Bản nháp').toList(),
            purpleColor,
          ),
          _buildArticleList(
            _allArticles.where((a) => a['status'] == 'Đã xuất bản').toList(),
            purpleColor,
          ),
        ],
      ),
