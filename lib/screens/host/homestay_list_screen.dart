...
class _HomestayListScreenState extends State<HomestayListScreen> {
  ...
  final List<Map<String, dynamic>> _homestays = [
    ...
    },
    {
      ...
      'rating': 4.6,
      'image':
          'https://images.unsplash.com/photo-1449156001437-3a1441df910b?q=80&w=1000&auto=format&fit=crop',
    },
    {
      'name': 'A-Frame Escape',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors
            .white, // Nền trắng cho thanh công cụ phía trên nhằm làm nổi bật ô tìm kiếm phía dưới
        elevation: 0, // Khử bóng đổ của thanh AppBar
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: Color(0xFF6D4C41)),
          onPressed: () =>
              Navigator.pop(context), // Quay lại giao diện màn hình trước đó
        ),
        title: const Text(
          'Tất cả Homestay',
          style: TextStyle(
            ...
            fontFamily:
                'BeVietnamPro', // Đảm bảo khai báo cấu hình font tương ứng trong pubspec.yaml
          ),
        ),
        actions: [
          IconButton(
            icon: const Icon(
              Icons.tune,
              color: Color(0xFF6D4C41),
            ), // Nút cấu hình nhanh bộ lọc nâng cao
            onPressed: () {},
          ),
        ],
      ),
          ...
          Expanded(
            child: GridView.builder(
              padding: const EdgeInsets.all(
                16,
              ), // Tạo biên đệm 16 đơn vị bao quanh vùng lưới ô cờ
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount:
                    2, // Thiết lập hiển thị cố định chia làm 2 cột hàng dọc
                crossAxisSpacing:
                    16, // Khoảng cách trống giữa các cột kế bên nhau
                mainAxisSpacing:
                    16, // Khoảng cách trống giữa các dòng phía trên và phía dưới
                childAspectRatio:
                    0.72, // Tỷ lệ vàng tương quan giữa chiều rộng và chiều cao của mỗi ô Card
              ),
              itemCount: _homestays
                  .length, // Định số lượng thẻ cần vẽ dựa theo mảng dữ liệu đầu vào
              itemBuilder: (context, index) {
                return _buildHomestayCard(
                  _homestays[index],
                ); // Vẽ cấu trúc chi tiết từng thẻ ô cờ nhỏ
              },
            ),
          ),
        ],
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        backgroundColor: const Color(
          0xFF6D4C41,
        ), // Màu sắc nâu chủ đạo cho nút bấm nổi
        icon: const Icon(
          Icons.map_outlined,
          color: Colors.white,
        ), // Biểu tượng bản đồ
  ...
  Widget _buildSearchAndFilter() {
    return Container(
      color: Colors
          .white, // Phủ màu nền trắng đồng điệu liên mạch với AppBar phía trên
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(
                  0xFFF7F4E1,
                ), // Sắc be nhạt tương phản nhẹ giúp làm nổi bật ô nhập dữ liệu
              ...
              child: const TextField(
                decoration: InputDecoration(
                  ...
                  border: InputBorder
                      .none, // Xóa bỏ viền gạch chân mặc định của TextField
                  icon: Icon(
                    Icons.search,
                    color: Color(0xFFE07A5F),
                  ), // Biểu tượng kính lúp sắc cam
                ),
              ),
            ),
          ),
          ...
          SizedBox(
            height:
                40, // Giới hạn chiều cao an toàn bao quanh các nút Filter Chip
            child: ListView(
              ...
              children: [
                _buildFilterChip(
                  'Gần đây',
                  true,
                ), // Thẻ mặc định giả định được kích hoạt
  ...
  Widget _buildFilterChip(String label, bool isSelected) {
    return Container(
      margin: const EdgeInsets.only(
        right: 8,
      ), // Tạo khoảng hở đệm giữa các nhãn kề nhau
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(
          20,
        ), // Tạo hình dáng viên thuốc bo tròn mềm mại
        border: Border.all(
      ...
      child: Center(
        child: Text(
          ...
          style: TextStyle(
            color: isSelected
                ? Colors.white
                : Colors.grey.shade700, // Đổi màu chữ tương phản theo nền nhãn
            fontSize: 12,
  ...
  Widget _buildHomestayCard(Map<String, dynamic> homestay) {
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(
          16,
        ), // Bo tròn bốn góc cho thẻ ô cờ 16 đơn vị
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(
              0.03,
            ), // Đổ bóng mờ nhẹ tạo cảm giác nổi tinh tế
            blurRadius: 8,
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  ), // Chỉ bo góc tròn phía trên của ảnh
                  child: Image.network(
                    homestay['image'],
                    width: double.infinity,
                    height: double.infinity,
                    fit: BoxFit
                        .cover, // Cắt cúp ảnh cân đối lấp đầy vùng chứa của ô lưới
                  ),
                ),
                ...
                Positioned(
                  ...
                  child: CircleAvatar(
                    backgroundColor: Colors.white.withOpacity(
                      0.8,
                    ), // Nền trắng mờ trong suốt
                    radius:
                        14, // Kích thước vòng tròn bao quanh icon thu nhỏ gọn gàng
                    child: const Icon(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        overflow: TextOverflow
                            .ellipsis, // Xuất hiện dấu ba chấm ngắt quãng nếu tên quá rộng
                      ),
                    ),
                    Row(
                      children: [
                        const Icon(
                          ...
                          color: Colors.amber,
                          size: 12,
                        ), // Biểu tượng ngôi sao vàng đánh giá
                        Text(
                          ' ${homestay['rating']}',
                          style: const TextStyle(
                            fontSize: 10,
                ...
                Text(
                  ...
                  maxLines: 1,
                  overflow: TextOverflow
                      .ellipsis, // Giới hạn nội dung địa chỉ hiển thị khít trên duy nhất 1 dòng
                ),
                    ...
                    children: [
                      TextSpan(
                        ...
                        style: const TextStyle(
                          color: Color(
                            0xFFE07A5F,
                          ), // Điểm xuyết sắc cam thương hiệu cho thông số giá cả
                          fontWeight: FontWeight.bold,
                          fontSize: 14,
                        ),
                      ),
