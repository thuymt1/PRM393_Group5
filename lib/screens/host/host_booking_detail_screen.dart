...
class _HostBookingDetailScreenState
    extends ConsumerState<HostBookingDetailScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(
              height: 100,
            ), // Khoảng trống đệm an toàn cuối dòng tránh bị che bởi thanh BottomSheet
          ],
        ),
      ),
      bottomSheet: _buildActionButtons(
        context,
      ), // Cụm nút đôi tác vụ duyệt hoặc từ chối ghim cố định đáy màn hình
    );
  }
  ...
  Widget _buildStatusBanner() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors
            .orange
            .shade50, // Nền màu cam nhạt tạo tín hiệu lưu ý kiểm duyệt
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: Colors.orange.shade100,
        ), // Đường viền sắc cam nhạt
      ),
      child: const Row(
        children: [
          Icon(
        ...
        children: [
          CircleAvatar(
            ...
            backgroundImage: avatarUrl != null
                ...
                : const NetworkImage('https://i.pravatar.cc/150?u=user1'),
          ),
          ...
          IconButton(
            ...
            ), // Điểm xuyết sắc cam thương hiệu cho nút chat
            onPressed: () {
    ...
    return _buildSectionCard(
      ...
      Column(
        children: [
          ...
          const Divider(
            height: 32,
          ), // Đường vạch kẻ ngang phân tách mảnh tạo không gian thông thoáng
          _buildInfoRow(
            ...
            children: [
              ...
              Text(
                ...
                style: const TextStyle(
                  ...
                  fontWeight: FontWeight.bold,
                  color: Color(0xFFE07A5F),
                ), // Làm nổi bật số tiền thu nhập bằng sắc cam cam
              ),
            ],
          ),
        ],
      ...
      children: [
        ...
        Container(
          ...
          child: const Text(
            ...
            ), // Giãn cách dòng 1.5 kết hợp chữ in nghiêng tinh tế
          ),
        ),
      ],
    );
  ...
  Widget _buildInfoRow(IconData icon, String label, String value) {
    return Row(
      children: [
        ...
        ), // Đặt màu sắc cam thương hiệu cho các biểu tượng đầu dòng
  ...
  Widget _buildActionButtons(BuildContext context) {
    if (_booking['status'] != 'pending' &&
      ...
      if (statusStr == 'refunded') statusStr = 'Đã hoàn/hủy';
      return Container(
    ...
    return Container(
      padding: const EdgeInsets.fromLTRB(
        ...
        24,
        32,
      ), // Chừa biên đệm dưới 32 đơn vị bảo toàn phần tai thỏ / thanh vuốt hệ thống
      decoration: BoxDecoration(
        color: Colors.white,
        boxShadow: [
          BoxShadow(
            ...
            blurRadius: 10,
            offset: const Offset(0, -5),
          ), // Hiệu ứng đổ bóng đổ ngược lên trên
        ],
      ),
      child: Row(
        children: [
            ...
            child: OutlinedButton(
              ...
              style: OutlinedButton.styleFrom(
                ...
                side: const BorderSide(
                  color: Colors.red,
                ), // Viền đỏ bao quanh nút bấm
                minimumSize: const Size(
                  0,
                  56,
                ), // Chiều cao hộp nút bấm chuẩn là 56 đơn vị
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(16),
                ),
              ),
          ...
          const SizedBox(
            width: 16,
          ), // Khoảng trống phân tách giữa hai phím nút bấm
          ...
          Expanded(
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(
                  0xFF6D4C41,
                ), // Sắc màu nâu đậm chủ đạo hệ thống
                minimumSize: const Size(0, 56),
                elevation:
                    0, // Triệt tiêu đổ bóng mặc định giúp phím phẳng mượt tinh tế tiệp vào nền trắng BottomSheet
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(16),
                ),
              ),
  ...
  Future<void> _updateBookingStatus(String newStatus) async {
    ...
    try {
      await ref
          ...
          .updateStatus(_booking['id'], newStatus);
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Đã cập nhật trạng thái đơn!')));
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize
              .min, // Thu hẹp chiều cao hộp thoại khít vừa số lượng phần tử con bên trong
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text(
              ...
              style: TextStyle(
                ...
                color: Colors.grey,
                height: 1.4,
              ), // Giãn dòng 1.4 thông thoáng văn bản
            ),
            const SizedBox(height: 16),
            // Ô TextField tiếp nhận thông tin lý do giải trình gỡ đơn phòng từ phía chủ nhà
            TextField(
              maxLines:
                  3, // Giới hạn chiều cao ô hiển thị mặc định rộng 3 dòng chữ nhập
              decoration: InputDecoration(
                ...
                fillColor: Colors
                    .grey
                    .shade100, // Phủ lớp nền màu xám nhạt mịn màng sạch sẽ
