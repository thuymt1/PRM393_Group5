...
// Lớp cấu hình MaterialApp dùng để bọc màn hình Hủy đặt phòng khi kiểm thử độc lập
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Hearth & Horizon - Hủy Đặt Phòng',
      ...
      home: const CancelBookingPage(), // Đặt CancelBookingPage làm màn hình mặc định khi khởi động
    );
  }
}

// Màn hình tiếp nhận yêu cầu hủy phòng và lấy lý do từ khách hàng
