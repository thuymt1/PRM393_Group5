...
// Lớp cấu hình MaterialApp dùng để bọc màn hình Nhập thông tin Homestay khi kiểm thử độc lập
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Hearth & Horizon - Đăng Tin Mới',
      ...
      home: const AddHomestayBasicInfoScreen(), // Đặt AddHomestayBasicInfoScreen làm màn hình mặc định khi khởi động
    );
  }
}

// Màn hình Bước 1: Nhập các thông tin cơ bản khi đăng tin Homestay mới dành cho Chủ nhà
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              // In log kiểm thử dữ liệu nhập vào trước khi điều phối luồng
              print("--- Dữ liệu Bước 1 ---");
              print("Tên nhà: ${_nameController.text}");
              print("Mô tả: ${_descriptionController.text}");
              print("Loại hình lưu trú: $_selectedStayType");

              // TODO: Điều phối kết nối Navigator chuyển tiếp sang bước tiếp theo (Vị trí - Add Location Screen)
            },
