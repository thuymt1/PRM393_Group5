...
// Lớp cấu hình MaterialApp dùng để bọc màn hình Vị trí Homestay khi kiểm thử độc lập
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Hearth & Horizon - Thiết Lập Vị Trí',
      ...
      home: const AddHomestayLocationScreen(), // Đặt AddHomestayLocationScreen làm màn hình mặc định khi khởi động
    );
  }
}

// Màn hình Bước 2: Nhập địa chỉ cụ thể và định vị không gian trên bản đồ dành cho Chủ nhà
