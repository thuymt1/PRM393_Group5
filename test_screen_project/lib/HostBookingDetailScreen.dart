...
// Lớp cấu hình MaterialApp dùng để bọc màn hình Chi tiết yêu cầu khi kiểm thử độc lập
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Hearth & Horizon - Chi Tiết Yêu Cầu',
      ...
      home: const HostBookingDetailScreen(), // Đặt HostBookingDetailScreen làm màn hình mặc định khi khởi động
    );
  }
}

// Màn hình xem chi tiết thông tin yêu cầu đặt phòng dành cho Chủ nhà
