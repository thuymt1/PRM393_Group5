...
// Lớp cấu hình MaterialApp dùng để bọc màn hình Danh sách Chuyến đi khi kiểm thử độc lập
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Hearth & Horizon - Chuyến Đi Của Tôi',
      ...
      home: const MyBookingsScreen(), // Đặt MyBookingsScreen làm màn hình mặc định khi khởi động
    );
  }
}

// Màn hình hiển thị danh sách các đơn đặt phòng phân loại theo Tab trạng thái
